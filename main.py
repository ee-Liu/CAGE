...
def get_args_parser():
    parser = argparse.ArgumentParser('CAGE', add_help=False)
    ...
    # backbone
    parser.add_argument('--backbone', default='swinv2_L_192_22k', type=str,#resnet50 swinv2_L_192_22k swin_L_384_22k
    ...
    # loss coefficients
    parser.add_argument('--cls_loss_coef', default=0.6, type=float)
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        tensorboardwriter.add_scalar('GPU Memory Allocated',peak , epoch)
